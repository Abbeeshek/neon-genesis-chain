const IBTCIntegration = () => {
  return (
    <section className="py-24 relative">
      <div className="absolute inset-0 circuit-pattern opacity-10" />
      <div className="container mx-auto px-6 relative z-10">
        <h2 className="text-4xl md:text-5xl font-bold mb-8 text-center">
          <span className="text-primary glow-blue">🔗</span> How It Integrates with MiniBitcoin (IBTC)
        </h2>
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          <div className="p-8 bg-card rounded-xl border border-primary/30 border-glow-blue">
            ...
            <p className="text-muted-foreground mb-4">IBTC is the primary token used for:</p>
          ...
          <div className="p-8 bg-card rounded-xl border border-secondary/30 border-glow-gold">
            ...
            <p className="text-muted-foreground">
              IBTC holders can participate in securing the network and earn passive rewards.
            </p>
          </div>
...
export default IBTCIntegration;
